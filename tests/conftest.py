...
from pes_apiv1.db.utils import create_database, drop_database
from pes_apiv1.settings import settings
from pes_apiv1.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    from pes_apiv1.db.models import load_all_models
